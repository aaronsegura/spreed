...
class RoomService {
	...
	public function setExpireDate(Room $room, Participant $participant, int $seconds): void {
	...
	public function getExpireDate(Room $room): int {
		return $room->getExpireDate();
	}
}
