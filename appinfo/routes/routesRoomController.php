...
return [
	'ocs' => [
		...
		/** @see \OCA\Talk\Controller\RoomController::setExpireDate() */
		['name' => 'Room#setExpireDate', 'url' => '/api/{apiVersion}/room/{token}/message-expire', 'verb' => 'POST', 'requirements' => $requirements],
	],
];
